const paketWisata = {
  paket1: {
    ...
    hargaPerPenumpang: 125000, // Ganti dengan harga per penumpang yang sesuai
  },
  paket2: {
    hargaKendaraan: 0, // Ganti dengan harga awal jika ada
  ...
  paket3: {
    hargaKendaraan: 0, // Ganti dengan harga awal jika ada
    hargaPerPenumpang: 200000, // Ganti dengan harga per penumpang yang sesuai
  },
...
function redirectToWhatsApp(paketId) {
  ...
  // Mengatur nama destinasi
  let namaDestinasi = "";
  if (paketId == 1) {
    namaDestinasi = "Soreang";
  } else if (paketId == 2) {
    namaDestinasi = "Ciwidey";
  }

  // Buat pesan yang akan dikirim ke WhatsApp
  const message = `Saya memesan Paket ${namaDestinasi} dengan mobil ${namaMobil} dan berjumlah ${jumlahPenumpang} penumpang.`;
